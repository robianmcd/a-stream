...
import {AStreamConstructorOptions, DefaultAStreamOptions} from './base-a-stream';
import type {AStreamOptions} from './base-a-stream';

export class StateStream<Params extends any[], TResult> extends BaseStateStream<Params, TResult, Params> {
    constructor(
